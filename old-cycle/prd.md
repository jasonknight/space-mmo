...
4. Save PRD: Save the generated document as prd-[feature-name].md inside the ./tasks directory. if ./tasks does not exist, create it.
...
6. Scope/Boundaries: "Are there any specific things this feature should not do (non-goals)?"
